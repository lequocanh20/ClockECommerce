...
using clockECommerce.WebApp.Data;
using clockECommerce.WebApp.LocalizationResources;
...
namespace clockECommerce.WebApp
{
    public class Startup
    {
        ...
        {
            StripeConfiguration.ApiKey = "sk_test_51K2C1tGvDddAkKFYNEn9tIptqJZoxZhGWk8yBNUWae9uLksd6bkHHyEWKrHAhi2DvmLDSPe0wyxAGmk0gSCRlXu800VEXM0Ii6";
