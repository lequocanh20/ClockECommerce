...
namespace clockECommerce.ApiIntegration
{
    public class UserApiClient : BaseApiClient, IUserApiClient
    {
        ...
        public async Task<ApiResult<string>> Authenticate(LoginRequest request)
        {
            ...
            var data = await PostAsync<ApiResult<string>>(
                "/api/users/authenticate", httpContent);
            return data;
        }
        ...
        public async Task<ApiResult<bool>> Delete(Guid id)
        {
            ...
            var data = await DeleteAsync<ApiResult<bool>>(
                $"/api/users/{id}");
            return data;
        }
        ...
        public async Task<ApiResult<UserViewModel>> GetById(Guid id)
        {
            ...
            var data = await GetAsync<ApiResult<UserViewModel>>(
                $"/api/users/{id}");
            return data;
        }
        ...
        public async Task<ApiResult<PagedResult<UserViewModel>>> GetUsersPagings(GetUserPagingRequest request)
        {
            ...
            //return users;
            var data = await GetAsync<ApiResult<PagedResult<UserViewModel>>>(
        ...
        public async Task<ApiResult<bool>> RegisterUser(RegisterRequest registerRequest)
        {
            ...
            var data = await PostAsync<ApiResult<bool>>(
                $"/api/users", httpContent);
            return data;
        }
        ...
        public async Task<ApiResult<bool>> RoleAssign(Guid id, RoleAssignRequest request)
        {
            ...
            //return JsonConvert.DeserializeObject<ApiErrorResult<bool>>(result);
            var data = await PutAsync<ApiResult<bool>>(
                $"/api/users/{id}/roles", httpContent);
            return data;
        }
