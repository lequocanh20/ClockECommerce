...
namespace clockECommerce.WebApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterRequest registerRequest)
        {
            ...
            email.Send("lequocanh.qa@gmail.com", user.ResultObj.Email, "XÁC NHẬN TÀI KHOẢN", confirmationLink);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel request)
        {
            ...
            var email = new EmailService.EmailService();
            email.Send("lequocanh.qa@gmail.com", request.Email, "Link khôi phục mật khẩu", passwordResetLink);
