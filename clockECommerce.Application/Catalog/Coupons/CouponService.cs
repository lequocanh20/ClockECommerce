...
namespace clockECommerce.Application.Catalog.Coupons
{
    public class CouponService : ICouponService
    {
        ...
        public CouponService(clockECommerceDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Update(CouponUpdateRequest request)
        {
            ...
            if (coupon == null) throw new clockECommerceException($"Không thể tìm coupon có ID: {request.Id} ");
        ...
        public async Task<int> Delete(int couponId)
        {
            ...
            if (coupon == null) throw new clockECommerceException($"Không thể tìm coupon có ID: {coupon} ");
