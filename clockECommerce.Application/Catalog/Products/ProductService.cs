...
namespace clockECommerce.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(clockECommerceDbContext context, IStorageService storageService, IConfiguration configuration,
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null) throw new clockECommerceException($"Không thể tìm sản phẩm có ID: {request.Id} ");
        ...
        public async Task<int> Delete(int productId)
        {
            ...
            if (product == null) throw new clockECommerceException($"Không thể tìm sản phẩm có ID: {productId}");
